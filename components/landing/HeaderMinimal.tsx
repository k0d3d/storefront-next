    ...
    <header className="fixed top-0 z-50 w-full bg-black border-b border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 sm:gap-6 h-16">
          {/* Logo - Left */}
          <Link href="/" className="flex items-center logo-font ">
            <span className="text-white font-extrabold text-xl sm:text-2xl tracking-widest">
              {logo}
            </span>
          </Link>
          ...
          <Link
            href="#signup"
            className="hidden items-center justify-center px-4 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-base font-extrabold text-white rounded-full hover:scale-105 transition-all duration-300"
            style={{
